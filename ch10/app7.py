...
# The dataclass attribute generates default methods for your class, 
...
def get_db_session():
    if 'db' not in g:
        ...
        # To serialize and deserialize the UDT, you'll need to register
        # your dataclass with the driver. 
        ...
        # You can query for all columns now that you know how to handle your 
        # image UDT.
...
def create_article():
    ...
    # If you have image data in your request, you need to convert it to the
    # dataclass. 
    ...
    # The summary image can be the first image if one exists.
    summary_image = images[0] if len(images) > 0 else None

    # Update the ID generation so that you can pass in an existing ID, allowing
    # you to update an article. 
