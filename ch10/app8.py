...
def get_db_session():
    if 'db' not in g:
        profile = ExecutionProfile(
            ...
            # Rotate between the shards that own the given partition.  
        ...
        # By iterating over the prepared statements, you can set their consistency 
        # level.
        for statement in PREPARED_STATEMENTS.values():
            statement.consistency_level = ConsistencyLevel.LOCAL_QUORUM

        # By iterating over the idempotent queries, you can access 
        # their prepared statements and mark them as idempotent.
